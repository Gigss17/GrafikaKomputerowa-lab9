...
const baseGeometry = new THREE.CylinderGeometry(0.6, 0.6, 0.25, 100);
//podstawa1

const base = new THREE.Mesh(baseGeometry, material);

const upperBaseGeometry = new THREE.CylinderGeometry(0.5, 0.5, 0.35, 100);
//podstawa2
...
// }
let size = 0.2;
let geometry1 = new THREE.CylinderGeometry(6,6,28,100);
let lathe1 = new THREE.Mesh(geometry1, material);
lathe1.position.set(0, 0, -0.3);
//pozycja pionka
